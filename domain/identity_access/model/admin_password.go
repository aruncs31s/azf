...
// Verify verifies if the provided raw password matches (placeholder for bcrypt)
func (p *AdminPassword) Verify(rawPassword string) (bool, error) {
	return p.Matches(rawPassword), nil
}
